/**
 * Step 7 - Generating pointers file using TST which will be used to created inverted index file
 */
...
public class TST<Value> {
    ...
    **************************************************************/
    ...
    // to fetch position of words in the data dictionary
    public String[][] storing() throws FileNotFoundException {
        ...
        String [][] store = new String[11496][2];
        int i = 0;
        
        for (String key : st.keys()) {
            //StdOut.println(key + " " + st.get(key));
            store[i][0] = (st.get(key)) + "";
            store[i][1] = key;
            i++;
        }
