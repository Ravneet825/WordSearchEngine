...
public class TrieST<Value> {
   ...
   /**
    ...
    public String[] passing (String a) throws FileNotFoundException {
    
    	ReadFile1 r = new ReadFile1();
    	String[] keys = r.reading();
        ...
        String[] over = new String[2];
        String[] full = pass.toArray( new String[pass.size()]);
        ...
        if ( full.length == 1) {
        	...
        	int[] distance = new int[11496];
        	String[] s = new String[11496];
        	
        	Edit e = new Edit();
        	for ( int i = 0; i < keys.length; i++) {
        		distance[i] = (100 - e.editDistance(a, keys[i]));
        		s[i] = keys[i];	
        	}
        	...
        	int[] distance = new int[11496];	//11496
        	String[] s = new String[11496];
        	...
        	System.out.println("No search found for "+a );
        	for( int i = 0; i < 2; i++) {
        		System.out.println("Closest matching word:  " +s[i]);
        		System.out.println();
        		if( distance[i] >= 98) {
