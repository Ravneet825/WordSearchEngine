/**
 * File used to generate TST of input search string
 */

import java.io.FileNotFoundException;

/*************************************************************************
 *  Compilation:  javac TST2.java
...
public class TSTForInput<Value> {
    private int N;       // size
    ...
    **************************************************************/
    ...
    // fetching position of words present in the data dictionary
    public int[] storing( String[] a) throws FileNotFoundException {

    	ReadFile1 r = new ReadFile1();
    	String[] keys = r.reading();
    	int n = a.length;
    	
        TSTForInput<Integer> st = new TSTForInput<Integer>();
